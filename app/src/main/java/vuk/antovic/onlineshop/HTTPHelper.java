...
public class HTTPHelper {
    ...
    public static String BASE_URL = "http://192.168.1.127:3000";
    ...
    public JSONObject registerUser(String username, String email, String password, boolean isAdmin) throws IOException, JSONException{
        ...
        Log.i("MSG" , urlConnection.getResponseMessage());
        urlConnection.disconnect();
        return responseCode==SUCCESS?responseObject:null;
    ...
    public boolean changePassword(String username, String oldPassword, String newPassword) throws IOException, JSONException {
